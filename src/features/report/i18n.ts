...
const translations: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'editor.finalContent': '최종함량(%)',
    'editor.formulation100': '100%배합량(%)',
    'editor.prescriptionContent': '처방함량(%)',
    ...
    'chart.specRange': '규격 범위',
    'chart.outOfSpec': '규격 이탈',
    'chart.usl': '상한(USL)',
    'chart.lsl': '하한(LSL)',
  ...
  en: {
    ...
    'editor.finalContent': 'Final Content(%)',
    'editor.formulation100': '100% Formula(%)',
    'editor.prescriptionContent': 'Rx Content(%)',
    ...
    'chart.specRange': 'Spec Range',
    'chart.outOfSpec': 'Out of Spec',
    'chart.usl': 'USL',
    'chart.lsl': 'LSL',
